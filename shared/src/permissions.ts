...
export const PERMISSIONS = {
  ...
  CASE_CUT: 'case:cut',
  CASE_CUT_REWORK_REQUEST: 'case:cut_rework_request',
  CASE_CUT_REPORT_VIEW: 'case:cut_report_view',
...
export const PERMISSION_LABELS: Record<Permission, string> = {
  ...
  [PERMISSIONS.CASE_CUT]: 'Process cut cases',
  [PERMISSIONS.CASE_CUT_REWORK_REQUEST]: 'Request cut rework',
  [PERMISSIONS.CASE_CUT_REPORT_VIEW]: 'View cut performance reports',
...
export const PERMISSION_GROUPS: Record<Permission, PermissionGroup> = {
  ...
  [PERMISSIONS.CASE_CUT]: 'Cases',
  [PERMISSIONS.CASE_CUT_REWORK_REQUEST]: 'Cases',
  [PERMISSIONS.CASE_CUT_REPORT_VIEW]: 'Reports',
...
const ROLE_PERMISSIONS: Record<string, readonly Permission[]> = {
  ...
  [ROLES.COORDINATOR]: [
    ...
    PERMISSIONS.CASE_CUT_REWORK_REQUEST,
