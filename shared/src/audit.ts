export const AUDIT_ACTIONS = {
  ...
  AUTH_PREFERENCES_UPDATE: 'auth.preferences.update',
  ...
  CASE_CUT_ASSIGN: 'case.cut.assign',
  CASE_CUT_CLAIM: 'case.cut.claim',
  CASE_CUT_START: 'case.cut.start',
  CASE_CUT_SUBMIT: 'case.cut.submit',
  CASE_CUT_REWORK_REQUEST: 'case.cut.rework_request',
  CASE_CUT_REWORK_RESUBMIT: 'case.cut.rework_resubmit',
  ...
  CLARIFICATION_DRAFT_SAVE: 'clarification.draft_save',
  CLARIFICATION_PUBLISH: 'clarification.publish',
  CLARIFICATION_ESCALATE: 'clarification.escalate',
...
export const AUDIT_ACTION_LABELS: Record<AuditAction, string> = {
  ...
  [AUDIT_ACTIONS.AUTH_ACCOUNT_LOCKED]: 'Account locked after failed logins',
  [AUDIT_ACTIONS.AUTH_ACCOUNT_UNLOCKED]: 'Login lockout cleared',
  [AUDIT_ACTIONS.AUTH_PREFERENCES_UPDATE]: 'User preferences updated',
  ...
  [AUDIT_ACTIONS.INVOICE_BATCH]: 'Scheduled batch invoices generated',
  ...
  [AUDIT_ACTIONS.CASE_CUT_ASSIGN]: 'Cut case assigned',
  [AUDIT_ACTIONS.CASE_CUT_CLAIM]: 'Cut case claimed',
  [AUDIT_ACTIONS.CASE_CUT_START]: 'Cut work started',
  [AUDIT_ACTIONS.CASE_CUT_SUBMIT]: 'Cut work submitted',
  [AUDIT_ACTIONS.CASE_CUT_REWORK_REQUEST]: 'Cut rework requested',
  [AUDIT_ACTIONS.CASE_CUT_REWORK_RESUBMIT]: 'Cut rework resubmitted',
  ...
  [AUDIT_ACTIONS.CLARIFICATION_DRAFT_SAVE]: 'Clarification draft saved',
  [AUDIT_ACTIONS.CLARIFICATION_PUBLISH]: 'Clarification draft published',
  [AUDIT_ACTIONS.CLARIFICATION_ESCALATE]: 'Clarification escalation updated',
  [AUDIT_ACTIONS.CLARIFICATION_READ]: 'Clarification marked read',
